...
public class NoteActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        note =  new Note(NotesListActivity.noteIndex);
    ...
    void takePicture() {
        Intent intent = new Intent(this,JustCaptureActivity.class);
    ...
    void saveNote()  {
       ...
       String noteFileName = generateNoteDescriptionFileName(sku);
    ...
    String generatePhotosListFileName() {
        ...
        // Создаем имя файла
        String timeStamp = String.valueOf(System.currentTimeMillis());
        File newFile = new File(path.getPath() + File.separator + NotesListActivity.noteIndex + "_photosList" + ".txt");
